...
Policy ID: policy/1013  
Policy Name: Restriction on sale of mercury-containing lightbulbs  
Type: Standard  
Description:  
Mercury is highly toxic and energy-efficient alternatives are widely available. The following fluorescent lamps (lightbulbs) shall not be sold, offered for sale, or delivered to a retailer for subsequent sale in the state of Vermont.January 1, 2024 – Act No. 120. This act prohibits the sale or distribution in the State of four-foot general purpose, low pressure, mercury-containing linear fluorescent lamps (tubes).
