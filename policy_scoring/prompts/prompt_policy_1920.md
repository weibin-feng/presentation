...
Policy ID: policy/1920  
Policy Name: Energy Efficiency Triennium 2 Framework  
Type: Governance  
Description:  
New Jersey's Energy Efficiency (EE) framework aims to provide equitable access to energy efficiency programs for all residents and businesses, regardless of location, while supporting decarbonization efforts. It focuses on lowering energy costs, particularly for low-income and disadvantaged communities, ensuring they benefit equally from EE investments. The framework also emphasizes transparency in reporting, reducing program and administrative costs, and enhancing job opportunities and economic benefits across the state.EQUITY DETAILA priority of the framework is to create affordable access to EE programs for all market segments and for all New Jersey residents and businesses, regardless of geographic location, including through energy-efficient improvements that support New Jersey’s path toward decarbonization.
