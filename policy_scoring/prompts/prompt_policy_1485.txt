...
Policy ID: policy/1485  
Policy Name: State Fleet EV and Hybrid Procurement Requirements  
Type: Standard  
Description:  
Requires the Commissioner of Buildings and General Services, to the maximum extent practicable, to purchase and lease hybrid or plug-in electric vehicles for the State fleet with a minimum of 50%, bumped to 75% on July 1, 2021, of newly purchased and leased vehicles being hybrid or plug-in electric vehicles and requires the Commissioner to, whenever possible and provided that the vehicles are comparable and meet the State’s needs, only purchase or lease the lowest-cost year of the selected make and model and only the latest year model when it is the least expensive.
