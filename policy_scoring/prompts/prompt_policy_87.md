...
Policy ID: policy/87  
Policy Name: Zero-Emission Vehicle (ZEV) Rule  
Type: Standard  
Description:  
Colorado adopted the ZEV rule from California's Advanced Clean Cars regulatory program, which puts the state on a path to realizing 22% ZEV sales by model year 2025. This adoption came after the Colorado Air Quality Control Commission voted to adopt CA's LEV III rule from ACC in 2018, during which time there was extensive public comment in support of both Low and Zero Emission Vehicle Rules.
