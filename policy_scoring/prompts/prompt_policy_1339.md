...
Policy ID: policy/1339  
Policy Name: G3 Working Group  
Type: Governance  
Description:  
The objective of the G3 Working Group is to support public-private partnerships connected to the Local2030 Islands Network and to scale and accelerate locally and culturally relevant sustainability solutions to global challenges through the creation and implementation of an ambitious G3 Action Framework to meet the 17 UN SDGs, and to develop appropriate means to broaden public participation, awareness, and education regarding the task of addressing SDGs.
