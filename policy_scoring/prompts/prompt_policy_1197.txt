...
Policy ID: policy/1197  
Policy Name: State-Owned Buildings Energy Use Reduction Target  
Type: Targets/Goal  
Description:  
Reduce overall site energy use intensity (EUI), defined as weather-normalized Btu per square foot, from a 2004 baseline at state owned buildings by 20% in 2025 and 25% in 2030.
