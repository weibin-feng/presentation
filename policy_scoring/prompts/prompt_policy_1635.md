...
Policy ID: policy/1635  
Policy Name: Heat Pump Installation Goal  
Type: Targets/Goal  
Description:  
To continue Maine’s momentum, Governor Mills also unveiled a new target: installing another 175,000 additional heat pumps in Maine by 2027, thereby bringing the number of heat pumps installed in Maine homes, businesses, and public buildings during her time in office to 275,000. If this target is achieved, Maine would have more than 320,000 heat pumps in total installed across the state.Maine’s heat pump progress stems from legislation signed by Governor Mills in 2019, which established the state’s heat pump target of 100,000, enhanced heat pump rebate incentives through Efficiency Maine, and established a low-income heat pump program at MaineHousing. Through these programs, approximately 104,000 heat pumps have been installed in Maine.
