...
Policy ID: policy/1915  
Policy Name: The Green & Blue Infrastructure Policy Advisory Commission  
Type: Governance  
Description:  
The purpose of the Commission is to advise the Secretary of the Department of the Environment, the Baystat Subcabinet, and local government officials on ways to facilitate and accelerate the scale and pace of implementation of green and blue infrastructure projects in the state.EQUITY DETAILAs a result of this commission’s work, the Department of the Environment is coordinating with the Department of Emergency Management to develop a match-making tool to help nonprofits, community organizations, advance blue-green infrastructure projects with environmental justice communities.
