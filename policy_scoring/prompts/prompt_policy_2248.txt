...
Policy ID: policy/2248  
Policy Name: Electric Vehicle Coordinating Council (EVCC)  
Type: Governance  
Description:  
The Interagency Electric Vehicle Coordinating Council (EV Council) was established in 2022 to enable state agencies to collaborate on accelerating electric vehicle adoption and reducing greenhouse gas emissions from the transportation sector. The EV Council includes members of 10 state agencies who play a central role in the statewide effort to transition to electric vehicles (EVs). Agency members coordinate on policy development, program implementation, and funding opportunities so that all Washington residents can enjoy the benefits of EVs.
