...
Policy ID: policy/1992  
Policy Name: State ZEV Fleet Target  
Type: Standard  
Description:  
All passenger vehicles and light duty vehicles owned and operated by the State must be zero emission vehicles by 2040 by requiring increasing volumes of zero emission vehicles every few years.
