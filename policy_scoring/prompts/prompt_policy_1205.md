...
Policy ID: policy/1205  
Policy Name: Geothermal Energy Grant Program  
Type: Program  
Description:  
The Geothermal Energy Grant program supports the use of zero-emission, geothermal energy for electricity generation and space/water heating and cooling in homes, businesses, and communities.The grant program is anticipated to launch midyear 2023.
