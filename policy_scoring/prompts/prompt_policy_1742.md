...
Policy ID: policy/1742  
Policy Name: Michigan Energy Storage Target  
Type: Targets/Goal  
Description:  
By December 31, 2029, each electric provider whose rates are regulated by the commission shall petition the commission for any necessary approvals, and each alternative electric supplier shall submit a plan to the commission, to construct or acquire eligible energy storage systems or enter into eligible energy storage contracts to meet its share of a statewide energy storage target of a combined capacity of at least 2,500 megawatts
