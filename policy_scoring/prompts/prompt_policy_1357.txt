...
Policy ID: policy/1357  
Policy Name: Commission on Clean Energy Infrastructure Siting and Permitting (CEISP)  
Type: Governance  
Description:  
The CEISP will be tasked with reducing permitting timelines, providing communities’ input in the siting and permitting of clean energy infrastructure, and ensuring that the benefits of the clean energy transition are shared equitably. The Commission will also be instructed to make recommendations on administrative, regulatory, and legislative changes to existing permitting and siting procedures before the end of the year.The Commission will include representation from the following:State AgenciesEnvironmental and Land Use AdvocatesMunicipalitiesUtilitiesAgricultural InterestsEnvironmental Justice CommunitiesClean Energy DevelopersHousing and Real Estate DevelopersOther Stakeholders
