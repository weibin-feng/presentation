...
Policy ID: policy/417  
Policy Name: Climate Risk Map  
Type: Analysis and Tools  
Description:  
The Climate Risk Map is designed to help New Mexico communities and residents learn more about factors that contribute to their climate change risk. The tool can visualize data related to air quality, drought, heat, flooding, and wildfire in New Mexico.
