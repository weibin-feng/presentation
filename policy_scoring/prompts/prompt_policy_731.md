...
Policy ID: policy/731  
Policy Name: Consumption-based Greenhouse Gas Emissions Inventory for Oregon  
Type: Analysis and Tools  
Description:  
Oregon’s consumption-based inventory measures greenhouse gas emissions produced around the world due to the state’s consumption of goods and services like cars, food, fuels, appliances and clothing—many of which are produced in other states or overseas. This inventory accounts for total emissions from producing, using and disposing of a product.The consumption-based inventory supplements DEQ’s sector-based inventory, which measures emissions that occur inside the state’s borders, as well as emissions from generating electricity that is imported for use in Oregon.
