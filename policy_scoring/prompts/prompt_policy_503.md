...
Policy ID: policy/503  
Policy Name: Buy Clean Oregon  
Type: Standard  
Description:  
The 2022 measure requires the state’s Department of Transportation to establish a program by 2025 to reduce GHG emissions from materials used in transportation infrastructure construction and maintenance, including concrete, steel, and asphalt. The Department will require contractors to submit EPDs and assess limitations in data, methods, and implementation of such a program. Prohibits department from using environmental product declarations to rank or score bid or proposal before January 1, 2027
