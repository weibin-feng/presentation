...
Policy ID: policy/241  
Policy Name: Offshore Wind Energy in Maryland  
Type: Targets/Goal  
Description:  
In 2030 and later, 50% from Tier 1 Renewable Sources, including: An amount set by the Commission under 7–704.2(A) of this subtitle derived from offshore wind energy, including at least 1,200 megawatts of Round 2 offshore wind projects.
