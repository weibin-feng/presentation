...
Policy ID: policy/2089  
Policy Name: Transit Service Goal  
Type: Targets/Goal  
Description:  
For transit, reaching the non-auto mode share sub-goal would necessitate an increase in transit service of 83% (measured by transit revenue miles) from the current level of 79 million transit revenue miles to 145 million in 2035.
