...
Policy ID: policy/2151  
Policy Name: Tribal Climate Resilience Program  
Type: Program  
Description:  
The Tribal Climate Resilience Program Grants support Tribes in strengthening their climate resilience. In collaboration with Washington Tribes, Commerce has developed a strategy for distributing $50 million in Climate Commitment Act (CCA) funds allocated by the Washington Legislature for the 2023-2025 biennium. These grants can be used for various project phases, including planning, feasibility studies, pre-construction, and construction costs.
