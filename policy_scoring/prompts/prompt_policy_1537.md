...
Policy ID: policy/1537  
Policy Name: Clean Ground Transportation Working Group  
Type: Governance  
Description:  
A working group comprised of agency leads and other stakeholders to achieve the zero-emissions goals established under SB 1204 for ground transportation.JUST TRANSITION DETAILEnabling legislation notes that the Working Group shall consider equity concerns, including economic and accessibility impacts to low—income communities.
