...
Policy ID: policy/1979  
Policy Name: Hydrogen and Clean Fuels Program  
Type: Program  
Description:  
Developers of new technologies for the use of clean fuels find technical assistance and commercialization support in NYSERDA’s Hydrogen and Clean Fuel Program. Investment AreasClean hydrogen production utilizing renewables such as solar, wind, hydropower, andClean hydrogen infrastructure including transmission, distribution andClean hydrogen applications in transportation, building heating, industrial processes, power generation, grid firming and energy storageInnovation in other low carbon clean fuels, such as green ammonia and sustainable aviation fuel.
