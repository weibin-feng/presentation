...
Policy ID: policy/58  
Policy Name: State Infrastructure Planning  
Type: Governance  
Description:  
Required state agencies to take into account the current and future impacts of climate change when planning, designing, building, operating, maintaining, and investing in state infrastructure.
