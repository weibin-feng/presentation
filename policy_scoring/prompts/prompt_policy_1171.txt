...
Policy ID: policy/1171  
Policy Name: Weatherization for Homes and Businesses by 2030  
Type: Targets/Goal  
Description:  
To reflect the state's goal of capturing all cost-effective energy efficiency for both electricity and natural gas (vs. percentage-based targets) and to incorporate new goals set forth in the state's climate action plan. The revised targets (beyond capturing all cost-effective energy efficiency) include reducing energy costs, weatherizing 35,000 homes and businesses (including 10,000 low-income households) by 2030
