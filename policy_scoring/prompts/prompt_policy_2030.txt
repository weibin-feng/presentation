...
Policy ID: policy/2030  
Policy Name: On-site Energy Manager Program  
Type: Program  
Description:  
The Program targets Commercial, Multifamily, and Industrial facilities, campuses, or portfolios that do not have an existing dedicated full-time on-site energy manager. It seeks to demonstrate the value of an on-site energy manager role at a given facility such that the role becomes standardized and self-sustaining. NYSERDA will contribute up to 75% towards the allowable fees.
