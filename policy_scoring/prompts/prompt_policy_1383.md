...
Policy ID: policy/1383  
Policy Name: Arizona Energy Efficiency Standards  
Type: Standard  
Description:  
Both APS and TEP are required to achieve at least 1.3% annual energy efficiency savings over the next three-year planning period and to report these savings in their 2023 Integrated Resource Plan. Both utilities are also required to include a demand-side resource capacity equal to at least 35% of 2020 peak demand.
