...
Policy ID: policy/1560  
Policy Name: Environmental Standards Procurement Task Force  
Type: Governance  
Description:  
To be established by October 1, 2023, the Environmental Standards Procurement Task Force will advise the Dept. of Administration and state DOT on EPD collection requirements, industry incentives, GWP limits, and other aspects to help the state create a Buy Clean program.
