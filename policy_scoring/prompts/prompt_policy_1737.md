...
Policy ID: policy/1737  
Policy Name: Maine Infrastructure Adaptation Fund  
Type: Program  
Description:  
The Fund, first announced by Governor Mills in December 2021, was a recommendation of the state’s climate action plan, Maine Won’t Wait, to support community efforts to build climate resilience in Maine.RESILIENCE DETAILMaine Infrastructure Adaptation Fund recipients will use the funds for projects to address flooding along ocean and riverfronts, protect stormwater and wastewater systems, install culverts to reduce flooding; and ensure energy availability during extreme storms.
