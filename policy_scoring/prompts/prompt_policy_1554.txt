...
Policy ID: policy/1554  
Policy Name: Utility Transportation Electrification Planning  
Type: Analysis and Tools  
Description:  
No later than January 1, 2021, and thereafter upon request by the Public Regulation Commission, but no more frequently than every two years, a public utility shall file with the commission an application to expand transportation electrification.
