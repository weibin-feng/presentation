...
Policy ID: policy/69  
Policy Name: Community Air Protection Program  
Type: Program  
Description:  
The Program’s focus is to reduce exposure in communities most impacted by air pollution. Communities around the State are working together to develop and implement new strategies to measure air pollution and reduce health impacts.
