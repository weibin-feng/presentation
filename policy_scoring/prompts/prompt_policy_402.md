...
Policy ID: policy/402  
Policy Name: Clean Cars New Mexico  
Type: Standard  
Description:  
Adopted California's Advanced Clean Cars program, requiring 22% ZEV sales in the state starting in Model Year 2026 and further reducing emissions from non-ZEVs through the LEV III rule.
