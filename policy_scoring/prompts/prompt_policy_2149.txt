...
Policy ID: policy/2149  
Policy Name: Oregon Conservation Corps  
Type: Program  
Description:  
The Oregon Legislature established the Oregon Conservation Corps to fund partner organizations throughout the state that employ young Oregonians to clear the land of the hazardous fuels that feed wildfires. This program is designed to create fire-adapted communities, while training the future workforce.JUST TRANSITION DETAILThis bill supports a just transition through workforce development and job opportunities in the wildfire management space.RESILIENCE DETAILThis program is intended to build resilience against wildfires in Oregon through workforce development.
