...
Policy ID: policy/2157  
Policy Name: Clean Mobility Options  
Type: Program  
Description:  
Clean Mobility Options (CMO) is a statewide public program that empowers under-resourced communities across California to better understand and overcome mobility obstacles with vouchers that fund community needs assessments and clean, shared, zero-emission transportation projects. It provides funding and technical support for two types of projects: clean mobility projects and community transportation needs assessments.Goals include:Improve access to clean mobility options that are safe, reliable, convenient, and affordable.Advance workforce development in the clean transportation sector.Increase zero-emission vehicle adoption.Reduce vehicle miles traveled.Advance mobility equity.Improve local air quality.
