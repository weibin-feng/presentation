...
Policy ID: policy/1726  
Policy Name: 100% Zero-Emission Maryland Transit Administration Bus Procurements  
Type: Standard  
Description:  
Prohibiting, beginning in fiscal year 2023, the Maryland Transit Administration from purchasing buses for the Administration's State transit bus fleet that are not zero-emission buses.
