...
Policy ID: policy/1663  
Policy Name: 100% zero-emission school bus procurement requirement  
Type: Standard  
Description:  
Beginning in fiscal year 2025, a county board of education may not enter into a new contract for the purchase of any school bus that is not a zero–emission vehicle; or the use of any school bus that is not a zero–emission vehicle, unless the school bus has an in–service date of July 1, 2024, or before.
