...
Policy ID: policy/2006  
Policy Name: Renewables Ready Communities Award  
Type: Program  
Description:  
The Renewables Ready Communities Award is an initiative launched in 2024 with a one-time state investment of $30 million and later expanded through EPA CPRG funds. The program provides financial incentives, on top of tax revenue and community benefits, to local and tribal governments that approve and host utility-scale renewable energy and energy storage through local processes.
