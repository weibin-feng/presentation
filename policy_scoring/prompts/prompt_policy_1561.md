...
Policy ID: policy/1561  
Policy Name: Buy Clean EPD Grants  
Type: Program  
Description:  
The University of Minnesota's Center for Sustainable Building Research (CSBR), in collaboration with the Minnesota Department of Administration and Minnesota Department of Transportation, seeks proposals from Minnesota-based manufacturers of eligible construction materials/products to create Environmental Product Declarations (EPDs) under the "Buy Clean" legislative funding.The maximum grant per grantee will be $49,999.00.Grants awarded will either be assigned from the Department of Administration ($255,000 total available) or the Department of Transportation ($310,000 total available).
