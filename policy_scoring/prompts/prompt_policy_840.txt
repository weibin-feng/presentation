...
Policy ID: policy/840  
Policy Name: Colorado Building Performance Standards  
Type: Standard  
Description:  
Building Performance Standards create energy performance targets, such as specific reductions in energy use or greenhouse gas (GHG) emissions, for buildings to meet after a set amount of time. These standards, usually preceded by a benchmarking program that tracks building energy use, help drive energy efficiency improvements and beneficial electrification investments that save energy and money, and reduce GHG pollution from buildings over time.The "Energy Performance for Buildings" statute (referred to as House Bill 21-1286) established sector-wide emission reduction targets of 7% by 2026 and 20% by 2030 from a 2021 energy use. In order to achieve these GHG emissions reduction targets from buildings, the State created building performance standards that apply to all commercial, multifamily, and public buildings 50,000 square feet and larger.
