...
Policy ID: policy/1507  
Policy Name: Stretch Energy Code  
Type: Standard  
Description:  
The Stretch energy code is a key requirement for municipalities that are Green Communities.The Stretch energy code (Stretch Code) regulations have since 2009 been published in MA 780CMR chapters 115.aa and previously 780 CMR 110.aa under the jurisdiction of the Board of Building Regulations and Standards. The climate act of 2021 moved the authority for the Stretch Code promulgation to the Department of Energy Resources (DOER) and at the same time required the development of a new Municipal Opt-in Specialized energy code (Specialized Code).
