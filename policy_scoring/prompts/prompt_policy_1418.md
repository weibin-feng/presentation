...
Policy ID: policy/1418  
Policy Name: Uniform Floodplain Management Policy (Update)  
Type: Governance  
Description:  
The state’s floodplain management policy sets construction standards for state-owned buildings located in the floodplain. It was last updated in the '90s.Executive Order No. 266 directs NC DOA to update building requirements for new state construction located in a floodplain and to develop requirements for new state buildings located outside of a floodplain that are at risk of flooding.NC DOA will develop the updated policy with input from state agencies and interested stakeholders and publish the final policy in January, 2024. The updated policy will seek to mitigate risks for state construction, minimize flood damage considering the impacts of sea level rise and climate change, and support the benefits of natural infrastructure in managing flood risk.
