...
Policy ID: policy/1597  
Policy Name: 2030, 2050 GHG Emissions Reduction Targets  
Type: Targets/Goal  
Description:  
The State shall implement greenhouse gas emissions reduction strategies to ensure that, no later than January 1, 2030, Statewide greenhouse gas emissions on a net basis shall be reduced by not less than 50% from a 2005 Baseline. The State shall implement greenhouse gas emissions reduction strategies to ensure that, no later than January 1, 2050, greenhouse gas emissions in the State shall be stabilized at or below net zero emissions and shall not exceed that level thereafter.
