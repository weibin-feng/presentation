...
Policy ID: policy/584  
Policy Name: Washington's Updated Stationary HFC Standard  
Type: Standard  
Description:  
The adopted rule:Establishes maximum global warming potential (GWP) thresholds for hydrofluorocarbons used in new stationary refrigeration and air conditioning equipment, small cans of refrigerant, and certain nonessential consumer aerosol products.Establishes a refrigerant management program with registration, leak inspection, leak repair, recordkeeping, and reporting requirements for owners or operators of large stationary refrigeration and air conditioning systems.Establishes required service practices for technicians who service stationary refrigeration and air conditioning systems.Amends product labeling and disclosure requirements.Establishes new labeling and recordkeeping requirements.Updates Chapter 173-443 WAC to reflect other changes in the law.Revises the title of the chapter.A new section in Chapter 173-455 WAC establishes fees and a process for fee updates to cover the costs of implementing and enforcing the refrigerant management program.
