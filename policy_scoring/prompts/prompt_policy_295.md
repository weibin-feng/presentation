...
Policy ID: policy/295  
Policy Name: Multi-family Zoning Requirement For MBTA Communities  
Type: Standard  
Description:  
This new law requires that an MBTA community shall have at least one zoning district of reasonable size in which multi-family housing is permitted as of right and meets other criteria set forth in the statute:Minimum gross density of 15 units per acreLocated not more than 0.5 miles from a commuter rail station, subway station, ferry terminal or bus station, if applicableNo age restrictions and suitable for families with children
