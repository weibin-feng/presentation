...
Policy ID: policy/1300  
Policy Name: Colorado Low Emission Automobile Regulation (CLEAR)  
Type: Standard  
Description:  
Adopted California's LEV III rule under Advanced Clean Cars, requiring that as of model year 2022, all new light-and-medium-duty vehicles (up to 14,000 pounds GVWR) and Aftermarket Catalytic Converters sold in Colorado must meet LEV III standards.
