...
Policy ID: policy/2182  
Policy Name: Organics Management Law  
Type: Program  
Description:  
The state Legislature passed organics management laws in 2022 and 2024. These laws aim to divert organic materials away from landfills through prevention, food rescue, and organics management facilities.These actions will help Washington achieve its 2030 goal to reduce organic material in the landfill by 75%.Washington’s organics management laws will divert organics from landfills and reduce methane emissions, which is a key strategy to address climate change. These laws simultaneously create opportunities for food waste prevention and recovery while supporting the compost market.
