...
Policy ID: policy/1679  
Policy Name: DRIVE EV  
Type: Program  
Description:  
Driving Rhode Island to Vehicle Electrification DRIVE EV is an electric vehicle (EV) rebate program administered by the Rhode Island Office of Energy Resources (OER) to support adoption of electric vehicles by Rhode Island residents, small-businesses, non-profits, and public sector entities.Rebates also available for plug-in hybrids (PHEVs) and used electric vehicles (EVs).EQUITY DETAILFor individuals, up to additional $1,500 rebate based on income-eligibility under the DRIVE+ program. For fleet owners, extra $500 rebate per vehicle for applicants located in high-asthma municipalities.
