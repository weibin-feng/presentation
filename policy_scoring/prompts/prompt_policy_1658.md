...
Policy ID: policy/1658  
Policy Name: Control and Prohibition of CO2 Emissions: Electric Generating Units  
Type: Standard  
Description:  
The rule is expected to reduce CO2 emissions from fossil fuel-fired electric generating units through the application of output-based emission limits
