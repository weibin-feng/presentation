...
Policy ID: policy/1291  
Policy Name: Advanced Clean Cars I  
Type: Standard  
Description:  
Adopts California's Advanced Clean Cars I rule to require 22% zero-emission light-duty vehicle sales by model year 2025 and beyond (under the ZEV rule), and to reduce emissions from non-ZEV vehicles (under the LEV rule).Adopted in conjunction with Advanced Clean Trucks.
