...
Policy ID: policy/1410  
Policy Name: Interagency Resilience Team (IRT)  
Type: Governance  
Description:  
The Interagency Resilience Team (IRT) was established in the June 2020 Climate Risk Assessment and Resilience Plan. The Plan states (page 7-14):“The Chief Resilience Officer will convene an Interagency Resilience Team, which will include at least one resilience lead from each agency. These leads should be staff experts from each agency who have the authority, capacity, and expertise to collaborate on resilience work among agencies. This team will provide a coordinating structure for tackling interagency resilience issues. It also will support the development and release of updates to the North Carolina Resilience Plan in collaboration with the Climate Change Interagency Council. Ideally, this team will include representation from all state agencies, not only cabinet agencies.”The North Carolina Office of Recovery an Resilience first convened the IRT in September 2020, and it has met roughly monthly since then. The agendas include a round of updates from team members on any ongoing resilience work, new projects, and questions for the group. Agendas have also included deep dives on resilience issues such as updating the Enhanced State Hazard Mitigation Plan, how state agencies can take advantage of the Bipartisan Infrastructure Law, a review of Natural and Working Lands resilience efforts, the project to update the state’s Low Flow Statistics, and the state’s Broadband update. Because the IRT is comprised solely of state agency staff, its meetings are internal and not public. The IRT consists of 58 members from 11 state agencies.
