...
Policy ID: policy/1969  
Policy Name: The Green Schoolyard Grant program  
Type: Program  
Description:  
The purpose of this grant type is to create green schoolyards to protect the health, well-being, and educational opportunity of children most vulnerable to increasing temperatures and extreme heat across California. Projects shall be centered around improving the environmental conditions and experiences for school children with the highest levels of co-benefits.EQUITY DETAILProjects that meet the criteria for being in or benefiting a disadvantaged community, low-income community, and in-need educational facilities will be eligible to have their cost share requirement reduced or completely waived.RESILIENCE DETAILExtreme heat is deadly, replacing asphalt with green spaces, trees and vegetation will provide more protection against extreme heat for kids.
