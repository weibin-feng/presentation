...
Policy ID: policy/2087  
Policy Name: Mode Shift Goal  
Type: Targets/Goal  
Description:  
Vision 2035 identifies sub-goals for strategies that boost trips made by non- auto modes of travel, which analysis has shown can achieve the 1.2 MMT GHG reduction goal by 2035. Doubling Colorado’s non-auto mode share from today’s level of 9.6% to 19.2% by 2035 is one sub-goal. This means that the percentage of trips in Colorado where people choose to take transit, walk, bike, or roll (instead of driving alone) would slightly more than double between 2024 and 2035.
