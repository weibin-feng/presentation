...
Policy ID: policy/2100  
Policy Name: Recovered Methane Credit Trading  
Type: Program  
Description:  
The recovered methane branch of the Greenhouse Gas Crediting and Tracking System began operating in 2023. This branch allows eligible recovered methane projects to generate and sell credits to gas distribution utilities operating in Colorado. The utilities can use the credits toward a portion of their Clean Heat Plan obligations. Per the Colorado Air Quality Control Commission Regulation No. 22, these credits can only be sold to gas distribution utilities with Clean Heat Plan requirements outlined in Senate Bill 21-264. The credits must be generated pursuant to the relevant protocols outlined in Section I.C. of the recovered methane rule.
