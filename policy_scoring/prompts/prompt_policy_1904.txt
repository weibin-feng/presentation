...
Policy ID: policy/1904  
Policy Name: Colorado IRA Urban & Community Forestry Grant Program  
Type: Program  
Description:  
The Colorado State Forest Service created the Colorado Inflation Reduction Act (IRA) Urban & Community Forestry (UCF) grant program with IRA funding from the USDA Forest Service. The 2024 grant cycle is the first of three rounds of funding over the next three years, and the CSFS has $1.6 million available in this first year.EQUITY DETAILThis new grant program is designed to grow the tree canopy in disadvantaged areas of Colorado. Eligible projects will prioritize capacity building and community engagement to improve forest canopies in disproportionately impacted (DI) areas, identified through the Climate and Economic Justice Screening Tool under the federal Justice40 Initiative.
