...
Policy ID: policy/1071  
Policy Name: Joint Task Force on ​​Resilient Efficient Buildings (REBuilding)  
Type: Governance  
Description:  
Joint Task Force on Resilient Efficient Buildings was established to identify and evaluate policies related to building codes and building decarbonization for new and existing buildings that would enable the state to meet GHG emissions goals while maximizing other benefits.
