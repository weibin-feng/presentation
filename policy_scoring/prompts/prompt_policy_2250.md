...
Policy ID: policy/2250  
Policy Name: Embodied carbon intergovernmental coordinating council  
Type: Governance  
Description:  
The council is required to: develop an embodied carbon reduction plan, which will recommend requiring major building and transportation projects to collect EPDs; use low-carbon materials - especially cement, concrete, steel, glass, asphalt, and wood; recommend a process to set GWP values for these materials on or before January 1, 2026; develop EPD procurement procedures for state government; examine interactions with other laws, including ways to integrate embodied carbon reduction into the state building codes; and study best practices to increase building reuse.
