...
Policy ID: policy/1517  
Policy Name: ORDER ADOPTING THE FIRST NEW JERSEY COST TEST  
Type: Analysis and Tools  
Description:  
By this Order, the Board directs electric public utilities and gas public utilities in the state to use the New Jersey Cost Test to perform benefit-cost analyses during the first three-year program cycle of energy efficiency (“EE”) and peak demand reduction (“PDR”) programs pursuant to the EE provisions of the Clean Energy Act of 2018. The Act’s requirement that each portfolio of programs must have a benefit-to-cost ratio (“BCR”) greater than or equal to 1.0 means that each portfolio must yield positive net benefitsTo develop the initial NJ Cost Test (NJCT), Staff started with the energy costs and benefits traditionally included in the TRC, as a foundation. Staff then proposed for inclusion additional avoided energy benefits and non-energy impacts that are relevant to New Jersey’s policy goals and can be applied based on readily available research and industry consensus. The result is a test that Staff believes both better reflects the full range of benefits and costs that result from EE and PDR programs and allows for the timely development of the programs.SOCIAL COST OF GREENHOUSE GAS DETAILAmong the non-energy impacts, NJ staff included avoided emissions impacts which were calculated for electric and natural gas using the 3% discount rate “Annual SC-CO2,” adjusted for today’s dollars, as published in the 2016 IWG Technical Update
