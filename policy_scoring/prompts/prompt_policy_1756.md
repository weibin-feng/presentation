...
Policy ID: policy/1756  
Policy Name: Clean Air Program (CAP) Grants  
Type: Program  
Description:  
The Clean Air Program (CAP) is a competitive grant program administered by CEO, with a total funding amount not to exceed $25 million over the program’s six-year duration, sunsetting June 30, 2028.CAP will provide grants for energy efficiency improvements, renewable energy, electrification projects, methane capture projects, sustainable aviation fuel, use of low carbon hydrogen, and carbon capture at industrial facilities to achieve additional emission reductions beyond those required by regulation.
