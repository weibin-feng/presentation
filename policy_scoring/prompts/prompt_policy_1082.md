...
Policy Name: Multi-Unit Dwelling (MUD) Electric Vehicle (EV) Charging Station Deployment Working Group  
Type: Governance  
Description:  
Multi-Unit Dwelling (MUD) Electric Vehicle (EV) Charging Station Deployment Assessment The Hawaii State Energy Office must convene a working group to evaluate opportunities and barriers for installing EV charging stations in MUDs. The working group must:
