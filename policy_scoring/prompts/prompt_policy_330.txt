...
Policy ID: policy/330  
Policy Name: Clean Cars Minnesota  
Type: Standard  
Description:  
Adopts California's Advanced Clean Cars I package, including the ZEV rule requiring 22% ZEV sales in the state by model year 2025 and LEV III rule to reduce emissions from non-ZEV vehicles between model years 2017 through 2025.
