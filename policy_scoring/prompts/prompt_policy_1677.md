...
Policy ID: policy/1677  
Policy Name: MileageSmart Vermont  
Type: Program  
Description:  
The high fuel-efficiency used vehicle program provides financial assistance to income-eligible Vermonters at the point-of-sale to purchase used fuel-efficient vehicles. MileageSmart can contribute up to 25% of the vehicle purchase price, with a maximum of $5,000.EQUITY DETAILAs one program criteria element, applicants must be at or below 80% of the State Medium Income to qualify.
