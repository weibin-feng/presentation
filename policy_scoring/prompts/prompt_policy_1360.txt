...
Policy ID: policy/1360  
Policy Name: Medium–Duty and Heavy–Duty Zero–Emission Vehicle Grant Program  
Type: Program  
Description:  
For each of fiscal years 2024 through 2027, a person or a unit of local government may apply to the Administration for a grant under the Program. In each of fiscal years 2024 through 2027, the Governor shall include in the annual budget bill an appropriation of at least [$1,000,000] $10,000,000 from the Strategic Energy Investment Fund for grants for qualified NEWLY MANUFACTURED medium–duty or heavy–duty zero–emission vehicles OR ZERO–EMISSION HEAVY EQUIPMENT PROPERTY under the Program.
