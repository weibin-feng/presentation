...
Policy ID: policy/1879  
Policy Name: Tribal Nature-Based Solutions Program  
Type: Program  
Description:  
The Tribal Nature-Based Solutions Program was established to support the return of over 38,000 acres of ancestral land to tribal stewardship and advance nature-based solutions projects on tribal lands. The grant program will support tribal priorities, which may include ancestral land return, restoration, workforce development, implementation of Traditional Ecological Knowledge and tribal expertise, habitat restoration, and climate and wildfire resilience projects.EQUITY DETAILThis program emerged from the administration’s Native American truth and healing process. Project funding will support tribal priorities as determined by the tribes themselves.
