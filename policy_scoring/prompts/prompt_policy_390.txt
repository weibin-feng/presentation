...
Policy ID: policy/390  
Policy Name: Carbon-Footprint Reducing Concrete  
Type: Program  
Description:  
New Jersey enacted legislation establishing an incentive to award projects using concrete with a lower carbon footprint: The 2021 law requires builders to offer unit concrete products that “utilize carbon footprint-reducing technology,” defined as generating at least 50 percent less carbon emissions than conventional products. The law also offers tax incentives and requires state procurement agencies to use or require the use of this concrete product when possible
