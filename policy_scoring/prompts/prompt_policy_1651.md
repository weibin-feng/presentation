...
Policy ID: policy/1651  
Policy Name: 2030 VMT Reduction Target  
Type: Targets/Goal  
Description:  
Per Updated Policy Directive 14, Colorado has a target to reduce Vehicle Miles Traveled (VMT) and VMT per capita by ten percent (10%) on or before 2030, relative to current levels.
