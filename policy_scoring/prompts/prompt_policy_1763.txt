...
Policy ID: policy/1763  
Policy Name: Strategic Plan for Evaluating Transportation Project Emissions in the State Transportation Improvement Program  
Type: Standard  
Description:  
Under the act, the DOT commissioner must develop and implement a strategic plan to ensure that transportation projects included in the state transportation improvement program do not exceed the emissions reduction target. The plan must at least include the following:a definition of “transportation project” that excludes projects exempt from federal air quality standards (e.g., certain safety-related projects, pavement resurfacing, transit building renovations, new bus and rail car purchases, and bicycle and pedestrian facilities);the methodology for calculating the carbon dioxide emissions expected from future transportation projects; anda description of the carbon dioxide mitigation transportation projects, like public transportation improvements; bikeway, walkway, or other multiuse trail or path construction; and electric vehicle charging infrastructure installation.
