...
Policy ID: policy/97  
Policy Name: Just Transition Advisory Committee (JTAC)  
Type: Governance  
Description:  
The Just Transition Advisory Committee (JTAC) includes representatives of coal communities, labor unions, and utilities as well as issue experts and members of the Colorado General Assembly and the Governor’s Cabinet. The JTAC was responsible for creating, in partnership with local communities, the Draft Colorado Transition Plan, which informed today’s Colorado Just Transition Action Plan. The committee will continue to play a useful role by supporting the Office of Just Transition as it reports on its progress and updates its plan on an annual basis.
