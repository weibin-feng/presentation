...
Policy ID: policy/2158  
Policy Name: Commercial Refrigeration Grant Program  
Type: Program  
Description:  
The Massachusetts Department of Environmental Protection is providing financial incentives for voluntary adoption of more climate-friendly, low global warming potential (GWP) refrigerants in commercial refrigeration equipment across the state. Program funding is available to new or existing retail food locations, food banks, and nonprofit institutions in Massachusetts that are installing refrigeration systems containing ultra-low-GWP (<10) refrigerants.
