...
Policy ID: policy/252  
Policy Name: Advanced Clean Cars I  
Type: Standard  
Description:  
Adopts California's Advanced Clean Cars I regulation, which requires 22% ZEV sales in the state by model year 2025 under the ZEV rule, and reduces emissions from non-ZEVs under the LEV III rule.
