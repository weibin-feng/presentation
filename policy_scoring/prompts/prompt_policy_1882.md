...
Policy ID: policy/1882  
Policy Name: The Maryland the Beautiful Act​ Smart Growth Subcabinet Five-Year Plan  
Type: Targets/Goal  
Description:  
The Maryland the Beautiful Act requires the Smart Growth Subcabinet (soon to be Sustainable Growth Subcabinet) to develop and publish the first five- year plan by July 1, 2024 to outline how to meet the goals in the legislation. Because the first goal to conserve 30% (1,856,889 of 6,189,629 land acres) of Maryland land was already achieved in 2024, this plan focuses on efforts towards the second goal to conserve 40% of the land in Maryland by 2040. The plan states that the 40 by 40 goal should be tightly coupled with existing state priorities to ensure strategic conservation.
