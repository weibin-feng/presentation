...
Policy ID: policy/1391  
Policy Name: State Agencies' 100% Renewable Energy Procurement Target  
Type: Targets/Goal  
Description:  
OER shall continue to procure, on behalf of all state government agencies, the energy supply for electricity and natural gas. In addition, subject to funding opportunities and constraints, the State shall procure 100% of its electricity consumption from renewable sources.
