...
Policy ID: policy/1017  
Policy Name: Plan for Zero Net Energy Targets for State Facilities  
Type: Analysis and Tools  
Description:  
By 2023, DEEP and DAS shall develop a plan and a budget to achieve zero-GHG emissions for all new construction and major renovations funded by the State or in facilities owned/operated by the Executive Branch, targeting construction beginning in fiscal year 2024 and after. GreenerGov CT is in the process of assembling a cross-agency NetZero New Construction Team to develop this plan.
