...
Policy ID: policy/1752  
Policy Name: 100% State ZEV LDV and MHD Vehicle Fleet Target  
Type: Targets/Goal  
Description:  
The Executive Order sets the following minimum targets regarding use of ZEVs in the state's fleet:Conversion of light-duty vehicles in the state fleet to ZEVs by 2033; andConversion of medium- and heavy-duty vehicles in the state fleet to ZEVs by 2040.
