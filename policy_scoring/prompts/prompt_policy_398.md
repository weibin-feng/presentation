...
Policy ID: policy/398  
Policy Name: New Mexico Renewable Portfolio Standard  
Type: Standard  
Description:  
Specified targets are for IOUs. The New Mexico RPS also applies to rural electric cooperatives, but differently than IOUs. The standards for coops are: 40% renewable by 2025, 50% renewable by 2030, and 100% zero carbon of which 80% must be renewable by 2050. Munis are exempt.
