...
Policy ID: policy/1671  
Policy Name: Oregon Renewable Energy Siting Assessment Tool  
Type: Analysis and Tools  
Description:  
The ORESA tool is an interactive application that allows users to review data and input potential project characteristics in order to get a coarse level perspective of potential land use, military, natural resources and other considerations.
