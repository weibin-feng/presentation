...
Policy ID: policy/1496  
Policy Name: Greenhouse Gas Mitigation Requirements and Emissions Performance Standard for Power Plants  
Type: Standard  
Description:  
Ecology and local clean air agencies regulate small plants that generate more than 25 megawatts of electricity (MWe), but less than 350 MWe. Plants are required to meet greenhouse gas emission standards and offset, or mitigate, their carbon pollution under this rule.The Energy Facility Site Evaluation Council (EFSEC) regulates plants larger than 350 MWe.All power plants in Washington, or a power plant with an agreement with a retail utility serving customers in Washington, must meet a greenhouse gas emission performance standard. Renewable and nuclear-powered electricity, and long-term contracts with the Bonneville Power Administration, are exempt from the rule's requirements.TransAlta, a power plant in Centralia, has special requirements set by the Legislature. The TransAlta plant must comply with the greenhouse gas emission performance standard for one boiler by 2020 and the other boiler by 2025.
