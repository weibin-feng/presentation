...
Policy ID: policy/1427  
Policy Name: Dairy Digester Research and Development Program (DDRDP)  
Type: Program  
Description:  
CDFA’s Dairy Digester Research and Development Program (DDRDP) provides financial assistance for the installation of dairy digesters in California, which results in more than 10 million tons CO2E in reduced greenhouse gas emissions every year since 2018.
