...
Policy ID: policy/1110  
Policy Name: Sustainable Rebuilding Program  
Type: Program  
Description:  
In May, Colorado enacted a law to provide finance assistance for rebuilding homes and commercial buildings after a natural disaster with energy efficient heat pumps, energy storage, renewable energy generation, and electric vehicle charging stations. Two separate programs, the Disaster Resilience Rebuilding Program and the Sustainable Rebuilding Program, will help homeowners, rental owners, businesses and government entities rebuild after disasters, while the Sustainable Rebuilding Program will specifically cover costs associated with building high performing, energy efficient, and resilient homes and structures.
