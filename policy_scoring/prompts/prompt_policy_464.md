...
Policy ID: policy/464  
Policy Name: Clean Energy Plan  
Type: Targets/Goal  
Description:  
Clean Energy Plan Goals • Reduce electric power sector greenhouse gas emissions by 70% below 2005 levels by 2030 and attain carbon neutrality by 2050. • Foster long-term energy affordability and price stability for North Carolina’s residents and businesses by modernizing regulatory and planning processes. • Accelerate clean energy innovation, development, and deployment to create economic opportunities for both rural and urban areas of the state.
