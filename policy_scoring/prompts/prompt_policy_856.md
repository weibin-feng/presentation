...
Policy ID: policy/856  
Policy Name: Advanced Clean Cars II  
Type: Standard  
Description:  
This Advanced Clean Cars II rulemaking continues the existing program and applies to the 2026-2035 model year. It will require auto manufacturers to deliver 100% new zero emission battery electric and plug-in hybrid electric vehicles by 2035. The rules also includes updates to the program to ensure new gasoline and diesel vehicles sold through 2034 have the cleanest emissions possible.
