...
Policy ID: policy/2088  
Policy Name: Active Transportation Infrastructure Goals  
Type: Targets/Goal  
Description:  
Vision 2035 also sets additional enabling sub-goals:Bicycles: A 81% increase in bicycle infrastructure statewide, which would result in 3,540 miles of new bicycle routes (1,770 new miles of bicycle lanes and 1,770 new miles of separated bicycle paths and lanes).Sidewalks: A 3.4% statewide increase in sidewalks, resulting in 1,345 new miles of sidewalk on existing streets that currently lack sidewalks.
