...
Policy ID: policy/528  
Policy Name: Renewable Energy Standard  
Type: Standard  
Description:  
Renewable energy standard (RES) that Vermont electric distribution utilities (DUs) are required to meet. Under the RES, Vermont’s DUs must acquire and retire a minimum quantity of renewable energy attributes or Renewable Energy Credits (RECs), and to achieve fossil fuel savings from energy transformation projects. The requirements of the RES are broken down into three categories, or tiers, as follows: Tier I - Total Renewable Energy Tier II – Distributed Renewable Generation Tier III – Energy Transformation
