...
Policy ID: policy/1981  
Policy Name: Michigan Transportation Electrification Plan Filing Requirements  
Type: Program  
Description:  
These application instructions apply to a standard rate regulated electric utility Transportation Electrification Plans (TEPs). The application shall be consistent with these instructions, with each item labeled as set forth below. Any additional information considered relevant by the rate regulated electric utility may also be included in the application.EQUITY DETAILUtility TEPs shall include strategies and measures for expanding transportation electrification among low-income customers and underserved communities including: (i) adoption of PEV or installation of charging stations by income; (ii) how the rate regulated electric utility plans to equitably expand EV adoption; (iii) mapping of public charging stations and their proximity to EJ communities using the EV Charging Justice40 map; and (iv) listing any programs currently in place to assist equitable adoption of EV charging infrastructure.
