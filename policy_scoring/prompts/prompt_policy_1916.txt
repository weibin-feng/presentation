...
Policy ID: policy/1916  
Policy Name: Career and Technical Education Program  
Type: Program  
Description:  
The Career and Technical Education program serves schools and communities by designing programs to meet the needs of Hawai'i's labor workforce, The state’s pilot program for 2023-2024 school year provided a framework for incorporating career exploration, including those in clean energy, into high school curricula.EQUITY DETAILThe program works to ensure equity of access and increase participation rates and successful outcomes.
