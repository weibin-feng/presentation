...
Policy ID: policy/259  
Policy Name: Controls for Municipal Solid Waste Landfills  
Type: Standard  
Description:  
Final landfill methane regulation, which includes emissions monitoring, leak detection, and gas collection and control system requirements for specific active and inactive landfills in the state. The Department of Environment estimates the rule will achieve a 25 to 50 percent reduction in landfill methane emissions.
