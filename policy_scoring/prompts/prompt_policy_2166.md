...
Policy ID: policy/2166  
Policy Name: CT DEEP Environmental Justice Program  
Type: Program  
Description:  
CT DEEP has an Environmental Justice Program with a designated Administrator and an Outreach and Education Coordinator. The program generally assesses and respond to environmental problems in low-income and minority communities; develops strategies to increase public participation in the agency’s decision making process; identifies community health concerns in consultation with local and state departments of health.
