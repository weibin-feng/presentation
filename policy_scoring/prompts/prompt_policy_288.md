...
Policy ID: policy/288  
Policy Name: Massachusetts' Offshore Wind Procurement  
Type: Targets/Goal  
Description:  
Codifies a goal of procuring 5,600 MW of offshore wind no later than June 30, 2027. The Act also allows the Commonwealth to coordinate offshore wind solicitations with other New England states.EQUITY DETAILSets preferences for projects that make commitments to developing equitable workforce opportunitiesJUST TRANSITION DETAILEstablishes a trust fund to develop workforce training and educational opportunities for the offshore wind sector
