...
Policy ID: policy/1503  
Policy Name: Maine C-PACE  
Type: Program  
Description:  
A C-PACE program allows commercial property owners to access financing to undertake energy efficiency and clean energy improvements on their buildings and repay the investment over time.Maine’s C-PACE program was launched in the spring of 2023. However, before the C-PACE Program can begin accepting loan applications, interested municipalities and capital providers must register to participate in the program. The Efficiency Maine Green Bank is currently working through that process and anticipates that C-PACE will be available in participating municipalities by early summer, 2023.
