...
Policy ID: policy/409  
Policy Name: Energy Transition Act Coal Transition Programs  
Type: Program  
Description:  
EQUITY DETAILThe bill establishes three funds (Workforce Solutions, Economic Development, and Indian Affairs) that are tasked with engaging directly with affected communities on how to best allocate transition fundingJUST TRANSITION DETAILNew Mexico earmarked $40 million for economic development, severance, and retraining programs for coal industry employees
