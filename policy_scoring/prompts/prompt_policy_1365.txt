...
Policy ID: policy/1365  
Policy Name: Disadvantaged Communities Criteria and Map  
Type: Analysis and Tools  
Description:  
The Climate Act charged the Climate Justice Working Group (CJWG) with the development of criteria to identify disadvantaged communities to ensure that frontline and otherwise underserved communities benefit from the state’s historic transition to cleaner, greener sources of energy, reduced pollution and cleaner air, and economic opportunities.A fact sheet on the final criteria will be translated and, along with an interactive map and final report, will be made available online as soon as practicable.
