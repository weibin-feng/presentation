...
Policy ID: policy/1390  
Policy Name: Electric Vehicle Charging Stations at State-Owned Properties Target  
Type: Targets/Goal  
Description:  
State Agencies as a whole, and to the greatest extent feasible, individually, shall meet the following calendar year targets where applicable: Increase the total number of electric vehicle charging stations at state owned properties to: 200 by 2030
