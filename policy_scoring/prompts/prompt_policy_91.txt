...
Policy ID: policy/91  
Policy Name: Electrification Working Group  
Type: Governance  
Description:  
The Electrification group works with partners across the public and private sectors to facilitate the expansion of both electric vehicles and infrastructure across Colorado. Ongoing efforts include: The development and implementation of zero emission vehicle (ZEV) standards, to ensure Coloradans have greater choice in models, such as pickup trucks, SUVs, and more affordable electric vehicle options. The drafting and implementation of a Zero-Emission Vehicle & Clean Transportation Plan, building on existing strategies to support sustainable transportation. Engagement with transit agencies to continue their transition to electric transit buses, and to support them in understanding the barriers and funding sources.
