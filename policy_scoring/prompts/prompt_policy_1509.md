...
Policy ID: policy/1509  
Policy Name: Multifamily EV Pre-Wiring Requirements  
Type: Standard  
Description:  
Requirement for the state electrical board to adopt the multifamily EV pre-wiring requirements created by the Energy Code Board. Ensure new multifamily housing is built with low-cost prewiring for EV charging infrastructure in parking areas to increase affordable access to EV charging for future residents of multifamily buildings
