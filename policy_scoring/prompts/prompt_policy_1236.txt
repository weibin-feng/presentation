...
Policy ID: policy/1236  
Policy Name: Advanced Clean Cars II  
Type: Standard  
Description:  
​Advanced Clean Cars II (ACC II) builds on Maryland's existing Clean Cars Program to require manufactures to continuously increase the share of vehicles they sell that are electric - reaching 100% of passenger car and light truck sales in model year 2035.ACC II relies on currently available advanced technologies, including battery-electric, hydrogen fuel cell electric and plug-in hybrids electric vehicles.By adopting ACC II in 2023, Maryland's regulation will apply starting in model year 2027. ACC II also includes increasingly stringent standards for gasoline cars and heavier passenger trucks to continue to reduce smog-forming emissions.
