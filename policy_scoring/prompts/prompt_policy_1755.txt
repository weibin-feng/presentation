...
Policy ID: policy/1755  
Policy Name: Colorado Industrial Tax Credit Offering  
Type: Program  
Description:  
The Colorado Industrial Tax Credit Offering (CITCO) is a competitive, refundable tax refund administered through Colorado Energy OFfice. A total of $168 million in tax credits will be available over the program’s nine-year duration, through December 31, 2032.Industrial facilities may apply for this refundable tax credit to conduct industrial studies, such as energy and emissions audits, feasibility studies, or front-end engineering and design studies; or implement improvements that reduce emissions, such as electrification, carbon management, hydrogen utilization, and waste heat recovery. CEO will award up to 30% of approved costs for selected projects, not to exceed $1 million for studies or $5 million for improvements.
