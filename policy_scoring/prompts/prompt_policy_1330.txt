...
Policy ID: policy/1330  
Policy Name: Manufacturing Training Academies  
Type: Program  
Description:  
Governor Pritzker announces $15 million investment in advanced manufacturing academies to train students for jobs in clean energy and vehicles sector.The governor's economic plan calls for the establishment of two manufacturing training academies at downstate community colleges. Grants funded under this program will provide funds for capital improvements to support the creation of manufacturing training programs, which are providing career pathways to employment opportunities with regional employers needing to fill the growing industry demand for skilled workers with electric vehicle and/or energy storage education and experience.
