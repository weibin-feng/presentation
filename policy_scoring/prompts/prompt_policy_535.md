...
Policy ID: policy/535  
Policy Name: ANR Diversity & Equity Committee  
Type: Governance  
Description:  
The Vermont Agency of Natural Resources DEI Committee promotes justice, equity, diversity, and inclusion. The Committee was asked to strive for lasting institutional change that:Provides and promotes forums for mutual respect, an appreciation of differences, and cross-cultural understanding.Helps our Agency effectively connect with a changing and diverse public.Assists in the recruitment and retention of a more diverse work force that is representative of the Vermonters we serve.
