...
Policy ID: policy/1926  
Policy Name: 2023 State Hazard Mitigation and Climate Adaptation Plan  
Type: Program  
Description:  
The ResilientMass Plan is the Commonwealth’s innovative State Hazard Mitigation and Climate Adaptation Plan (SHMCAP), developed through robust engagement with state and local government agencies, subject matter experts, community focus groups, and other key stakeholders. Building on the science and findings of the 2022 Massachusetts Climate Assessment and the 2018 SHMCAP, the Plan identifies strategies and specific, measurable actions state agencies will take to address risks to the human health and safety, communities, critical assets and infrastructure, natural resources, governance, and economy of the Commonwealth. The Plan aligns with Massachusetts’ vision to ensure that the Commonwealth is prepared to withstand, respond to, recover from, and mitigate all types of emergencies and disasters—and complies with FEMA requirements for state eligibility for pre- and post-disaster federal funding.ResilientMass is an update to the now-expired 2018 SHMCAP, which was developed under EO 569.
