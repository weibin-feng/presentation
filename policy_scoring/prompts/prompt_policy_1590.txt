...
Policy ID: policy/1590  
Policy Name: Maine Won't Wait Dashboard  
Type: Analysis and Tools  
Description:  
This dashboard tracks numerical targets included in Maine Won’t Wait to inform the public and help evaluate whether evidence-based adjustments, enhancements or replacements to policies are needed in pursuit of the plan’s climate objectives. Over time, the dashboard will expand to include other key Maine Won’t Wait metrics as updated data becomes available, new programs are established, and state and federal climate investments are realized.
