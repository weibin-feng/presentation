...
Policy ID: policy/1592  
Policy Name: 100% Zero-Emission Transit Bus Procurement Requirement  
Type: Standard  
Description:  
On or after July 1, 2026, a Service Board (including the Chicago Transit Authority, PACE, or Metra) may not enter into a new contract to purchase a bus that is not a zero-emission bus for the purpose of the Service Board's transit bus fleet.
