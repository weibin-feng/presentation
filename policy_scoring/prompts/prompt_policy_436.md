...
Policy ID: policy/436  
Policy Name: Oil and Gas Methane Standard  
Type: Standard  
Description:  
Proposes revising the permitting process to promote best practices that result in the identification and reduction of emissions in operation, monitoring, emergency response.SOCIAL COST OF GREENHOUSE GAS DETAILutilized SC-GHG to compare the costs and benefits of regulations
