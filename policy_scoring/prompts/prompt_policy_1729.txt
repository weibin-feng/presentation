...
Policy ID: policy/1729  
Policy Name: Vehicle Miles Traveled (VMT) Reduction Toolkit  
Type: Analysis and Tools  
Description:  
This toolkit is an interactive document with information about Transportation Demand Management (TDM) measures that reduce VMT and the potential funding sources available to implement these measures. The toolkit is divided into two parts:TDM Summary Pages that describe each TDM measure including pros/cons, successful examples in North Carolina and elsewhere, and additional resources.Funding Pages that describe grant programs that could potentially be used to fund the implementation of the TDM measures.
