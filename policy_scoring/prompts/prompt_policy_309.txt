...
Policy ID: policy/309  
Policy Name: Municipal Opt-In ‘Net-Zero’ Specialized Stretch Code  
Type: Standard  
Description:  
Municipal Opt-In ‘Net-Zero’ Specialized Stretch Code: A new climate-focused energy code option was created by the 2021 Climate Act. DOER is developing this new code alongside the Stretch Energy Code update. However, the specialized code must also include:net-zero building performance standardsa definition of net-zero buildingdesigned to achieve MA GHG emission limits and sub-limits including a 50% GHG emissions reduction by 2030 from 1990 levels
