...
Policy ID: policy/865  
Policy Name: Climate Commitment Act Program  
Type: Standard  
Description:  
In 2021, the Washington Legislature passed the Climate Commitment Act (or CCA) which establishes a comprehensive, market-based program to reduce carbon pollution and achieve the greenhouse gas limits set in state law.The program will start Jan. 2023, and the first emissions allowance auction will take place in the second half of Feb. 2023.
