...
Policy ID: policy/2169  
Policy Name: NJ BPU Equity Working Group  
Type: Governance  
Description:  
The New Jersey Board of Public Utilities (BPU) has established an Equity Working Group consisting of representatives of overburdened communities, nongovernmental organizations, community-based organizations, university partners, industry partners, and state agency partners. The BPU’s Office of Clean Energy Equity, in collaboration with the Equity Working Group, makes recommendations to the Board regarding the clean energy programs and policies that best address the needs of disadvantaged and overburdened communities, and acts as a resource for the BPU Division of Clean Energy staff to receive feedback on current or future clean energy programs and policies.
