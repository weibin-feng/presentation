...
Policy ID: policy/1335  
Policy Name: Equity Considerations in PUC Decision-Making  
Type: Governance  
Description:  
Requires the PUC to incorporate equity considerations into decision-making. Part of that asks the state to develop definitions for ‘environmental justice’ and methods for incorporating equity.
