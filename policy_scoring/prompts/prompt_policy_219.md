...
Policy ID: policy/219  
Policy Name: Net Energy Billing  
Type: Program  
Description:  
Maine PUC offers two NEB programs: a kWh credit program for all electric utility customers; and an NEB tariff rate program available to non-residential customers.
