...
Policy ID: policy/83  
Policy Name: Utility GHG Emission Reduction Targets  
Type: Standard  
Description:  
Obligates utilities that own or operate generation to file clean energy plans to reduce GHG emission and other air pollutants at least 80% below 2005 levels by 2030.With SB 23-198, in addition to meeting the 2030 clean energy target, requires that any clean energy plan submitted on or after January 1, 2024, must also achieve at least a 46% reduction in greenhouse gas emissions caused by the entity's Colorado electricity sales by 2027 relative to 2005 levels.
