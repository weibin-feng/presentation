...
Policy ID: policy/245  
Policy Name: State Facilities' No- or Low-Carbon Electricity Supply Procurement Target  
Type: Targets/Goal  
Description:  
By January 1, 2030, each primary procurement unit must ensure that at least 75% of the electricity supply procured by the unit for use in State facilities is derived from no- or low-carbon energy sources.
