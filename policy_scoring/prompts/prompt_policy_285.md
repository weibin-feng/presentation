...
Policy ID: policy/285  
Policy Name: Clean Peak Energy Standard  
Type: Standard  
Description:  
The Massachusetts Clean Peak Energy Standard is designed to provide incentives to clean energy technologies that can supply electricity or reduce demand during seasonal peak demand periods established by DOER. DOER is required to annually increase the Minimum Standard by not less than 0.25% of kilowatt-hour sales by retail electricity suppliers.
