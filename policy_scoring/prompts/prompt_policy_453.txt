...
Policy ID: policy/453  
Policy Name: GreenNY Specification: Lower Carbon Concrete  
Type: Standard  
Description:  
To achieve the GHG reduction goals of the Climate Leadership and Community Protection Act the State needs to reduce the embodied carbon in our built environment. Concrete includes use of cement, which yields approximately 0.9 pounds of carbon emission equivalents (CO2e) for each pound of cement produced. Provides guidelines and GHG specifications for low carbon concrete, including use of EPDs.
