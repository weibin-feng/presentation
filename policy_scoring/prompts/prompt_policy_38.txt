...
Policy ID: policy/38  
Policy Name: Sustainable Transportation Equity Project (STEP)  
Type: Program  
Description:  
The California Air Resources Board will provide up to $22 million in grants to address transportation needs in disadvantaged and low-income communities with clean transportation options. Funding provided through the Sustainable Transportation Equity Project (STEP)EQUITY DETAILProjects must be in priority populations and are designed to address community residents’ needs and center residents’ expertise through all phases of project implementation.
