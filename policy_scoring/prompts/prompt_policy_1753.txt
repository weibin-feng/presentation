...
Policy ID: policy/1753  
Policy Name: Zero Emissions Plan  
Type: Analysis and Tools  
Description:  
The Executive Order directs the Department of Technology, Management, and Budget to prepare a Zero Emission Plan (ZEP) that supports conversion of the state fleet to zero-emission vehicles. The ZEP shall include:Fleet replacement schedules;EVSE siting and build-out plans;Program management plan and requirements;Operations and maintenance plan for ZEVs and EVSE; andAnticipated funding needs.EQUITY DETAILThe Department shall seek to site electric vehicle supply equipment (EVSE) on State-controlled property in Justice40 communities and in high-density areas which have been historically disadvantaged by higher pollution levels.
