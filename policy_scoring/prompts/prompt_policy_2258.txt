...
Policy ID: policy/2258  
Policy Name: Transportation Emissions Intensity Reduction Target  
Type: Targets/Goal  
Description:  
The 2023 Oregon Transportation Plan includes a Key Performance Indicator for transportation emissions intensity, outlining that the state aims to reduce CO2e per mile by 77% by 2050 by transitioning to cleaner vehicles and fuels.
